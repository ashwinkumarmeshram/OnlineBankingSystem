...
export const CustSignin = (email, password) => {
  return (dispatch) => {
    ...
    const url = "http://localhost:7070/customer/login";
    axios
...
export const CustRegister = (
  ...
  return (dispatch) => {
    ...
    const url = "http://localhost:7070/customer/register";
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const CustFundTransfer = (senderAccountNo, reciverAccountNo, amount) => {
  return (dispatch) => {
    ...
    console.log(body);
    const url = "http://localhost:7070/transaction";
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const CustChangeMob = (customerId, mobileNo) => {
  return (dispatch) => {
    ...
    const url = "http://localhost:7070/customer/updateMobileNumber";
    axios
...
export const CustChangePass = (customerId, password) => {
  return (dispatch) => {
    ...
    const url = "http://localhost:7070/customer/updatePassword";
    axios
      .put(url + "/" + customerId, body, header)
      .then((response) => {
        dispatch({
...
export const CustChangeEmail = (customerId, email) => {
  return (dispatch) => {
    ...
    const url = "http://localhost:7070/customer/updateEmail";
    axios
      .put(url + "/" + customerId, body, header)
      .then((response) => {
        dispatch({
...
export const FetchTransHistory = (customerId) => {
  return (dispatch) => {
    ...
    const url = "http://localhost:7070/customer/getTransaction";
    axios
